...
import { ApplianceProductDetails } from '../../../appliances/appliance-Product-details';

@Component({
  selector: 'app-mens-product-page',
  standalone:false,
  templateUrl: './mens-product-page.component.html',
  styleUrl: './mens-product-page.component.css'
})
export class MensProductPageComponent implements OnInit {
