...
@Component({
  selector: 'app-books-product',
  standalone:false,
  templateUrl: './books-product.component.html',
  styleUrl: './books-product.component.css'
})
export class BooksProductComponent implements OnInit{
 ...
 if(this.productDetails){
  this.cartService.BooksAddToCart(this.productDetails)
